...
# Десять дампов, а не тридцать: строки 1–2 таблицы раздела 3 политики обещают,
# что после удаления данные живут в резервных копиях не более 10 дней. Дампы
# содержат данные детей, и обещание должно быть исполнимым, а не красивым.
# Обратная сторона — глубина отката: ошибку в данных, замеченную на третьей
# неделе, откатывать будет уже не из чего. Менять это число можно только
# вместе с политикой.
KEEP=10
