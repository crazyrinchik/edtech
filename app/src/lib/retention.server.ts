...
// уничтожения по приказу Роскомнадзора от 28.10.2022 № 179 (его обещает
// п. 10 политики), снятие профилей, к которым законный представитель так
 ...
 * п. 9 политики («3 года после прекращения обработки»), сам журнал
 * уничтожения — п. 6 приказа № 179 (подтверждающие документы хранятся три
 * года со дня уничтожения).
 */
 ...
 *
 * Если выкладка этой версии съедет позже 5 сентября 2026 — подвиньте дату,
 * иначе льготный срок истечёт до того, как педагоги увидят предупреждение.
 */
export const UNCLAIMED_RULE_SINCE = "2026-08-26T00:00:00.000Z";
