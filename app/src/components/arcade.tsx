 ...
 *
 * Подключается тремя строками и одинаково во всех шести тренажёрах:
 *
 ...
 * числам, найденным подряд без промаха. В судоку — по цифрам, вставшим в
 * клетки подряд без промаха: неверную там просто не принимают.
 */
