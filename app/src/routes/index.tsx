    ...
    <section className="sov-hero">
      <div className="sov-shell sov-hero__grid">
        <div>
          ...
          <div className="sov-hero__parent">
    ...
    <section className="sov-section sov-shell">
      <div className="sov-cab">
        <div>
          ...
          <p className="sov-section__lead">
            Если с ребёнком занимается репетитор, попросите у него код приглашения: вы
            увидите занятия, домашние задания и результаты. Платить не нужно — подписку
            оплачивает педагог.
          </p>
          <p className="sov-section__lead">
            Если репетитора нет, занимайтесь сами: тот же тренажёр, те же темы, отдельный
            взрослый кабинет с прогрессом и лимитом времени.
          </p>
