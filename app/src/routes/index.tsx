...
function Landing() {
  return (
    <div className="sov">
      ...
      <Trainers />
      <HowItWorks />
      {/* Кабинет → цена → данные: родитель сначала видит, что получит,
          потом сколько это стоит, и уже после — как защищены данные.
          Раздел про 152-ФЗ снимает последнее возражение, поэтому стоит
          последним, а не разрывает путь между продуктом и ценой. */}
      <ForParents />
      <Plans />
      <Safety />
      <SiteFooter />
