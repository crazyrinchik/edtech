          ...
          <Fragment key="join">
            ...
            <form className="sov-form" style={{ marginTop: 32 }} onSubmit={submit}>
              ...
              {/* Профиль завёл репетитор, поэтому согласие прямо охватывает и
                  уже внесённые им данные — родитель должен видеть, что
                  подтверждает, а не догадываться. Отдельного документа
                  «Согласие» больше нет: по указанию юриста ссылки ведут на
                  оферту и политику, а это окно остаётся самостоятельным
                  разрешением родителя, а не отсылкой к документу. */}
              <label className="sov-check">
                <input
                  type="checkbox"
                  name="consentChildPd"
