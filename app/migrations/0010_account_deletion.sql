...
-- правомерность прошлой обработки (строка 7 таблицы раздела 3 политики: сведения о согласиях
...
-- отозвал. По истечении трёх лет след снимается зачисткой в
-- lib/retention.server.ts — с записью в журнал уничтожения (миграция 0013).
--
